...
from mltemplate.backend.gateway import (
    GatewayConnection, BestModelForExperimentInput, ChatInput, ClassifyIDInput, ClassifyImageInput, ListRunsInput,
    LoadModelInput, TrainInput)
...
class Server(MltemplateBase):
    ...
    code::
        ...
        $ python -m gunicorn -w 1 -b localhost:8081 -k uvicorn.workers.UvicornWorker mltemplate.backend.gateway.server:app
    ...
    def __init__(self, tracking_server_uri: Optional[str] = None):
        ...
        self.commands: List[str] = [
            'commands', 'models', 'load-model', 'classify-by-id', 'list-experiments', 'list-runs', 'list-models',
    ...
    def app(self):
        ...
        @_app.post('/best-model-for-experiment')
